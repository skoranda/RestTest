...
class HistoryRecordTest {
  ...
  public $plural = 'HistoryRecords';
  public $controller = 'history_records';
  ...
  public function run() {
    ...
    $body["$this->plural"][0]['Action'] = 'ECPM';
    $body["$this->plural"][0]['Comment'] = 'Created by REST API client';
