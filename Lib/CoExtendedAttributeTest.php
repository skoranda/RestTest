...
class CoExtendedAttributeTest {
  public $apiUser;
  public $name = 'CoExtendedAttribute';
  public $plural = 'CoExtendedAttributes';
  public $controller = 'co_extended_attributes';
  ...
  public function run() {
    ...
    $body["$this->plural"][0]['Name'] = 'somename';
    $body["$this->plural"][0]['DisplayName'] = 'Some Name';
    $body["$this->plural"][0]['Type'] = 'VARCHAR(32)';
    $body["$this->plural"][0]['Indx'] = false;
    ...
    $body["$this->plural"][0]['DisplayName'] = 'Some Other Name';
