...
class PasswordTest {
  ...
  public $plural = 'Passwords';
  public $controller = 'password_authenticator/passwords';
  ...
  public function run() {
    ...
    $body["$this->plural"][0]['PasswordAuthenticatorId'] = 1;
    $body["$this->plural"][0]['Person']['Type'] = 'CO';
    $body["$this->plural"][0]['Person']['Id'] = '2';
    $body["$this->plural"][0]['Password'] = '123456789';
    $body["$this->plural"][0]['PasswordType'] = 'CR';
    ...
    $body["$this->plural"][0]['Password'] = '987654321';
