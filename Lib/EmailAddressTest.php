...
class EmailAddressTest {
  ...
  public $plural = 'EmailAddresses';
  public $controller = 'email_addresses';
  ...
  public function run() {
    ...
    $body["$this->plural"][0]['Mail'] = 'some.user@my.org';
    $body["$this->plural"][0]['Type'] = 'official';
    $body["$this->plural"][0]['Verified'] = false;
    ...
    $body["$this->plural"][0]['Verified'] = true;
