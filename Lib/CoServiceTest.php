...
class CoServiceTest {
  ...
  public $plural = 'CoServices';
  public $controller = 'co_services';
  ...
  public function run() {
    ...
    $body["$this->plural"][0]['Name'] = 'Created by REST API';
    $body["$this->plural"][0]['Description'] = 'REST API test';
    $body["$this->plural"][0]['Status'] = 'Active';
    $body["$this->plural"][0]['Visibility'] = 'CoMember';
    $body["$this->plural"][0]['ServiceUrl'] = 'https://my.org/service';
    ...
    $body["$this->plural"][0]['Name'] = 'Edited by REST API';
