...
class AddressTest {
  public $apiUser;
  public $name = 'Address';
  public $plural = 'Addresses';
  public $controller = 'addresses';
  ...
  public function run() {
    ...
    $body["$this->plural"][0]['Street'] = '100 North Main';
    $body["$this->plural"][0]['Room'] = '200';
    $body["$this->plural"][0]['Locality'] = 'Nowhere';
    $body["$this->plural"][0]['State'] = 'Idaho';
    $body["$this->plural"][0]['PostalCode'] = '54568';
    $body["$this->plural"][0]['Country'] = 'USA';
    $body["$this->plural"][0]['Type'] = 'office';
    ...
    $body["$this->plural"][0]['State'] = 'Wisconsin';
