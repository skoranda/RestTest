...
class CoTAndCAgreementTest {
  public $apiUser;
  public $name = 'CoTAndCAgreement';
  public $plural = 'CoTAndCAgreements';
  public $controller = 'co_t_and_c_agreements';
  ...
  public function run() {
    ...
    $body["$this->plural"][0]['CoTermsAndConditionsId'] = 1;
