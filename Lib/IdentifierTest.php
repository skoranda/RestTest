...
class IdentifierTest {
  ...
  public $plural = 'Identifiers';
  public $controller = 'identifiers';
  ...
  public function run() {
    ...
    $body["$this->plural"][0]['Type'] = 'eppn';
    $body["$this->plural"][0]['Identifier'] = 'scott.koranda@ncsa.illinois.edu';
    $body["$this->plural"][0]['Login'] = true;
    ...
    try {
      ...
      $msg = "$this->name View (per entity) exception:" . $e->getMessage();
      throw new Exception($msg);
    }
    ...
    try {
      $result = $client->call($request, 403);
    } catch (Exception $e) {
      $msg = "$this->name Add exception:" . $e->getMessage();
      throw new Exception($msg);
    }
    ...
    // Assign
    $request = array();
    $request['uri']['path'] = "$this->controller/assign.json";
    ...
    try {
      ...
      $msg = "$this->name Assign exception:" . $e->getMessage();
      throw new Exception($msg);
    }
