...
class TelephoneNumberTest {
  ...
  public $plural = 'TelephoneNumbers';
  public $controller = 'telephone_numbers';
  ...
  public function run() {
    ...
    $body["$this->plural"][0]['CountryCode'] = '01';
    $body["$this->plural"][0]['AreaCode'] = '555';
    $body["$this->plural"][0]['Number'] = '5555555';
